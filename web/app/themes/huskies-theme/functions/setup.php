...
function enqueue_scripts() {
  ...
  wp_register_script('stick', VENDOR_PATH.'/stickUp2/build/js/stickUp.min.js', array('jquery'));
  wp_register_script('skrollr', VENDOR_PATH.'/skrollr/dist/skrollr.min.js');
  wp_register_script('main_script', THEMEROOT.'/app.js', array('gallery', 'skrollr', 'stick'));
